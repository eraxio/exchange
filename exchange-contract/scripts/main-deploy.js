...
async function main() {
    ...
    const eraxExchange = await EraxExchange.deploy(eraxProxyRegistry.address, eraxTokenTransferProxy.address, "0x6b1218D1a79b06a811dc54E745C51d8cDF666c1d", owner.address);
