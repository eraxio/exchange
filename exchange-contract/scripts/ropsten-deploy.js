...
async function main() {
    ...
    const eraxExchange = await EraxExchange.deploy(eraxProxyRegistry.address, eraxTokenTransferProxy.address, "0xe7035B8F44b5A454D1e61FC259cAee058971d7A1", owner.address);
